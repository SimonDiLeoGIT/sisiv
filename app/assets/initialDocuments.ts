export const initialDocuments = [
	{
		...
		content: {
			Compromiso:
				'La alta dirección se compromete a promover una cultura de calidad en toda la organización.',
			Objetivo:
				'Establecer un marco para la gestión de la calidad dentro de la organización.',
			'mejora-continua':
				'La organización se compromete a mejorar continuamente sus procesos y servicios.',
			'satisfaccion-cliente':
				'Nos enfocamos en cumplir y superar las expectativas del cliente.',
			cumplimiento:
				'Cumpliremos con los requisitos legales, reglamentarios y del cliente.',
		},
	},
	{
		id: 2,
		...
		content: {
			Objetivo_y_Alcance:
				'Definir el proceso para llevar a cabo auditorías internas en todos los departamentos de la organización.',
			Responsabilidades: '',
			Planificación_de_Auditorías: '',
			Ejecución_de_la_Auditoría:
				'Incluir reunión de apertura, recolección de evidencias, y reunión de cierre.',
			Informe_de_Auditoría: '',
			Seguimiento_y_Cierre:
				'Incluir plazos para implementar acciones correctivas y verificar su eficacia.',
		},
	},
	{
		id: 3,
	...
	},
	{
		...
		content: {
			'nombre-empresa': '',
			alcance:
				'Aplica a todos los procesos operativos dentro de la empresa.',
			'politica-calidad':
	...
	},
	{
		...
		content: {
			...
			meta3: '',
			recursos:
				'Recursos de operaciones para el crecimiento en eficiencia.',
	...
	},
	{
		...
		content: {
			Objetivo_y_Alcance:
				'Establecer un proceso para el control de documentos dentro del sistema de gestión de calidad, aplicando a todos los documentos críticos para la calidad.',
			Responsabilidades:
				'Cada departamento es responsable de actualizar y archivar sus documentos.',
			Planificación_de_Auditorías:
				'1. Verificación, 2. Aprobación, 3. Archivo, 4. Revisión periódica.',
			Ejecución_de_la_Auditoría:
				'Incluir reunión de apertura, recolección de evidencias, y reunión de cierre.',
			Informe_de_Auditoría:
				'Especificar qué debe incluir el informe y cómo se comunica.',
	...
	},
	{
		...
		content: {
			...
			meta3: '',
			recursos:
				'Recursos necesarios para cumplir con la satisfacción del cliente.',
			responsables:
